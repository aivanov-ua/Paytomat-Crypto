...
public class Bech32 {
    ...
    private static final char SEPARATOR = (char) 0x31;    // '1'

    private Bech32() {
    }

    public static String bech32Encode(String hrp, byte[] data) {
        return bech32Encode(hrp.getBytes(), data);
    }
    ...
    public static String bech32Encode(byte[] hrp, byte[] data) {
        ...
        System.arraycopy(new byte[]{SEPARATOR}, 0, ret, hrp.length, 1);
