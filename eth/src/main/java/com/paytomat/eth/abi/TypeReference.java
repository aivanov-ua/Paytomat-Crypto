 ...
 * This is so that we can pass around Typed {@link com.paytomat.eth.abi.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends com.paytomat.eth.abi.datatypes.Type>
    ...
    public static <T extends com.paytomat.eth.abi.datatypes.Type> TypeReference<T> create(
            final Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.paytomat.eth.abi.datatypes.Type>
