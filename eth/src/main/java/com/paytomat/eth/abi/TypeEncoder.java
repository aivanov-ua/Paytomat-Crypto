...
import com.paytomat.eth.abi.datatypes.Address;
import com.paytomat.eth.abi.datatypes.Array;
import com.paytomat.eth.abi.datatypes.Bool;
import com.paytomat.eth.abi.datatypes.Bytes;
import com.paytomat.eth.abi.datatypes.BytesType;
import com.paytomat.eth.abi.datatypes.DynamicArray;
import com.paytomat.eth.abi.datatypes.DynamicBytes;
import com.paytomat.eth.abi.datatypes.num.NumericType;
import com.paytomat.eth.abi.datatypes.StaticArray;
import com.paytomat.eth.abi.datatypes.Type;
import com.paytomat.eth.abi.datatypes.num.Ufixed;
import com.paytomat.eth.abi.datatypes.Utf8String;
...
import static com.paytomat.eth.abi.datatypes.Type.MAX_BIT_LENGTH;
import static com.paytomat.eth.abi.datatypes.Type.MAX_BYTE_LENGTH;
